...
export const en: LocaleStrings = {
    ...
    detectEnvironmentConfigureSystemDesc: 'Windows: user PATH; Linux/macOS: shell profile',
    detectEnvironmentPluginConfigured: 'Hermes path saved to extension settings: {0}',
    detectEnvironmentSystemConfigured: 'Added {0} to system PATH ({1}). Restart Cursor/VS Code or open a new terminal.',
    detectEnvironmentSystemAlreadyConfigured: 'System PATH already includes {0}.',
    ...
    detectEnvironmentSummaryConfigureViaMenu: 'Hermes was found but is not configured. Open the wrench menu and choose Environment configuration.',
