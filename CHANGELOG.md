...
- **Inline diff live test (✅ VERIFIED 2026-07-19, CSS overflow fix)**: overflow:hidden on .diff-preview was clamping group to 6px. Changed to visible. Do you see the colored diff panel now?
...
[0.3.2]: https://github.com/acester822/FTR10-Hermes-VSCode/compare/v0.3.1...v0.3.2
[0.3.1]: https://github.com/acester822/FTR10-Hermes-VSCode/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/acester822/FTR10-Hermes-VSCode/compare/v0.2.6...v0.3.0
[0.2.6]: https://github.com/acester822/FTR10-Hermes-VSCode/compare/v0.2.5...v0.2.6
[0.2.5]: https://github.com/acester822/FTR10-Hermes-VSCode/compare/v0.2.2...v0.2.5
